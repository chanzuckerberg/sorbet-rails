...
Note that we do not generate sigs for [overridden methods](https://github.com/chanzuckerberg/sorbet-rails/issues/19). It would show this message in the log when running the rake task:
```
