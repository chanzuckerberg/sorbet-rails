...
module Arel::Predications
  ...
  def does_not_match(other, escape = nil); end
  ...
  def matches(other, escape = nil); end
  def matches_all(others, escape = nil); end
  def matches_any(others, escape = nil); end
...
class Arel::Table
  ...
  def hash; end
  def having(expr); end
  def initialize(name, engine = nil); end
...
class Arel::Visitors::ToSql < Arel::Visitors::Reduce
  ...
  def visit_Arel_Nodes_Having(o, collector); end
...
class Arel::SelectManager < Arel::TreeManager
  ...
  def initialize(engine, table = nil); end
  def initialize_copy(other); end
...
class Arel::Nodes::NotRegexp < Arel::Nodes::Binary
end
...
class Arel::Nodes::Matches < Arel::Nodes::Binary
  def escape; end
  def initialize(left, right, escape = nil); end
end
