...
module ActiveSupport::Inflector
  ...
  def parameterize(string, sep = nil, separator: nil, preserve_case: nil); end
...
class String
  ...
  def mb_chars; end
  def parameterize(sep = nil, separator: nil, preserve_case: nil); end
...
module ActiveSupport::Callbacks
  ...
  def self.halt_and_display_warning_on_return_false; end
  def self.halt_and_display_warning_on_return_false=(obj); end
  extend ActiveSupport::Concern
end
...
class ActiveSupport::ExecutionWrapper
  ...
  def self._complete_callbacks=(val); end
  def self._complete_callbacks?; end
  def self._run_callbacks; end
  def self._run_callbacks=(val); end
  def self._run_callbacks?; end
  def self.active; end
...
class ActiveSupport::ExecutionWrapper::RunHook < Anonymous_Struct_1
...
class ActiveSupport::ExecutionWrapper::CompleteHook < Anonymous_Struct_2
...
class ActiveSupport::Reloader < ActiveSupport::ExecutionWrapper
  ...
  def self._class_unload_callbacks=(val); end
  def self._class_unload_callbacks?; end
