...
class SourceAnnotationExtractor::Annotation < Anonymous_Struct_3
...
module Anonymous_ActiveRecord_AttributeMethods_GeneratedAttributeMethods_4
  ...
  def version_previous_change(*args); end
  def version_previously_changed?(*args); end
...
class ActiveSupport::TestCase < Minitest::Test
  ...
  def self.use_transactional_fixtures=(*args, &block); end
  def self.use_transactional_fixtures?; end
