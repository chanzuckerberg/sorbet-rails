...
class Potion
  include ::Potion::GeneratedAttributeMethods
...
class Wizard
  ...
  def after_remove_for_spell_books=(val); end
  ...
  def before_add_for_spell_books=(val); end

  def before_add_for_spell_books?(); end

  def before_remove_for_spell_books(); end

  def before_remove_for_spell_books=(val); end
